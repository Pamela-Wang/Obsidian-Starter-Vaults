...
var SPLIT_INDEX = 99; // Split panes at the end
var Upcoming = /** @class */ (function (_super) {
    __extends(Upcoming, _super);
    function Upcoming() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Upcoming.prototype.onload = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.addCommand({
                            ...
                            callback: function () {
                                var dailyNotes = getAllDailyNotes_1();
                                var days = Math.trunc(_this.settings.days) + 1;
                                var createNotes = _this.settings.createNotes;
                                var activeFile = app.workspace.getActiveFile();
                                var activeView = app.workspace.getActiveViewOfType(require$$0.MarkdownView);
                                var activeLeafId = '';
                                if (activeView) {
                                    activeLeafId = activeView.leaf.id;
                                }
                                _this.closePanes(activeLeafId);
                                // Check if the current active file is a daily note
                                // If not, open daily notes starting from today
                                var startDate = moment();
                                var dayOffset = 0;
                                var noteDate = getDateFromFile_1(activeFile, 'day');
                                if (noteDate) {
                                    startDate = noteDate;
                                    dayOffset = 1;
                                }
                                var openPanes = function () {
                                    var _a;
                                    for (var i = dayOffset; i < days; i++) {
                                        var date = startDate.clone().add(i, 'day');
                                        var file = getDailyNote_1(date, dailyNotes);
                                        if (file) {
                                            // Open daily note in a new pane on the right
                                            var leaf = app.workspace.createLeafInParent(app.workspace.rootSplit, SPLIT_INDEX);
                                            leaf.openFile(file);
                                            var leafId = (_a = leaf.id) !== null && _a !== void 0 ? _a : null;
                                            if (leafId)
                                                _this.settings.leafIds.push(leafId);
                                        }
                                    }
                                };
                                if (createNotes) {
                                    ...
                                    for (var i = dayOffset; i < days; i++) {
                                        ...
                                        var file = getDailyNote_1(date, dailyNotes);
                                        if (!file) {
                                            queue.push(createDailyNote_1(date));
                                        }
                                    }
                                    if (queue.length) {
    ...
    Upcoming.prototype.closePanes = function (excludeId) {
        if (excludeId === void 0) { excludeId = ''; }
        this.settings.leafIds.forEach(function (id) {
            if (id === excludeId)
                return;
            var leaf = app.workspace.getLeafById(id);
            if (leaf)
                leaf.detach();
        });
        this.settings.leafIds = [];
    };
    Upcoming.prototype.loadSettings = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d;
    ...
    Upcoming.prototype.saveSettings = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var UpcomingSettingTab = /** @class */ (function (_super) {
    __extends(UpcomingSettingTab, _super);
    function UpcomingSettingTab(app, plugin) {
        var _this = _super.call(this, app, plugin) || this;
        _this.plugin = plugin;
        return _this;
    }
    UpcomingSettingTab.prototype.display = function () {
        var _this = this;
        ...
        new require$$0.Setting(containerEl)
            ...
            return text
                ...
                .setValue(_this.plugin.settings.days.toString())
        ...
        new require$$0.Setting(containerEl)
            ...
            return toggle
                .setValue(_this.plugin.settings.createNotes)
                .onChange(function (value) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
